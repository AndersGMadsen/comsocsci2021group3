...
In this project we have created an <a href="https://github.com/AndersGMadsen/comsocsci2021group3/blob/main/explainer_notebook/Explanatory_Project.ipynb"><b>explainer notebook</b></a> and a website. The explainer notebook contains a behind the scence view of the project with more technical explanations and the code we have written. The website is the public face of the project with layman explanations and interactive plots. In order to fully enjoy this website, we recommended the reader to use either Chrome, Safari, Edge or Brave to view this webpage. If anyone wants to have a look at the data we have gathered and used it can be found <a href="https://drive.google.com/file/d/10rFkj8gL3Pc8uw6IY2YfV5jqwy5FZhR8/view?usp=sharing"><b>here</b></a>. As a teaser, you can see an interactive network below of one way philophers could be grouped and connected.

<iframe align=middle id="serviceFrameSend" width="100%" height="800" frameborder="0" src="network/complete/index.html"></iframe>

This interactive plot was created using a modificed version of https://github.com/benmaier/netwulf.
...
**The six core-areas WordClouds using TF**
<img style="width: 100%;" src="assets/img/WordCloud_tf.png" alt="TF"/>

**The six core-areas WordClouds using TF-IDF**
