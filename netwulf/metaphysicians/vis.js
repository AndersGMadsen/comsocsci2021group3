...
function vis(new_controls) {
  ...
  function ticked() {
    ...
    context.font = "20px Helvetica";
    context.fillStyle = "#000000";
    context.fillText("Size: 395", width*0.01, height*0.98);
    context.fillText("Density: 0.105", width*0.17, height*0.98);
    context.fillText("Clustering: 0.588", width*0.38, height*0.98);
    context.fillText("Purity: 0.263", width*0.62, height*0.98);
    context.fillText("Bias: 1.160", width*0.81, height*0.98);
  }
